 ...
 * @returns {string}
 */
export function traceLimits() {
    let deferred1_0;
    let deferred1_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.traceLimits(retptr);
 ...
 * @returns {string}
 */
export function traceRgba(pixels, width, height, options_json) {
    let deferred4_0;
    let deferred4_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        ...
        wasm.traceRgba(retptr, ptr0, len0, width, height, ptr1, len1);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('trace_js_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
